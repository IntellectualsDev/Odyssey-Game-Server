...
import { Monster as MyGame_Example2_Monster } from '../example2/monster.d.ts';
import { Monster } from './monster.d.ts';
import { TestSimpleTableWithEnum } from './test-simple-table-with-enum.d.ts';
export var Any;
(function (Any) {
    Any[Any["NONE"] = 0] = "NONE";
