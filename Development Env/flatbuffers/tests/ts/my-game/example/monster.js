...
import { Ability } from './ability.d.ts';
import { Any, unionToAny } from './any.d.ts';
import { AnyAmbiguousAliases, unionToAnyAmbiguousAliases } from './any-ambiguous-aliases.d.ts';
import { AnyUniqueAliases, unionToAnyUniqueAliases } from './any-unique-aliases.d.ts';
import { Color } from './color.d.ts';
import { Race } from './race.d.ts';
import { Referrable } from './referrable.d.ts';
import { Stat } from './stat.d.ts';
import { Test } from './test.d.ts';
import { Vec3 } from './vec3.d.ts';
import { InParentNamespace } from '../in-parent-namespace.d.ts';
/**
