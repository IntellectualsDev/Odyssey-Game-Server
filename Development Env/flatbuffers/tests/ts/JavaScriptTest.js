...
import { Monster, MonsterT } from './my-game/example/monster.d.ts'
import { Test, TestT } from './my-game/example/test.d.ts'
import { Stat } from './my-game/example/stat.d.ts'
import { Vec3 } from './my-game/example/vec3.d.ts'
import { Color } from './my-game/example/color.d.ts';
import { Any } from './my-game/example/any.d.ts';
