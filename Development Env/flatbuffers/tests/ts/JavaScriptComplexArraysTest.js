...
import { ArrayStructT } from './arrays_test_complex/my-game/example/array-struct.d.ts'
import { ArrayTable, ArrayTableT } from './arrays_test_complex/my-game/example/array-table.d.ts'
import { InnerStructT } from './arrays_test_complex/my-game/example/inner-struct.d.ts'
import { NestedStructT } from './arrays_test_complex/my-game/example/nested-struct.d.ts'
import { OuterStructT } from './arrays_test_complex/my-game/example/outer-struct.d.ts'
import { TestEnum } from './arrays_test_complex/my-game/example/test-enum.d.ts'
