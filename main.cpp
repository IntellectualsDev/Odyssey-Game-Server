...
int main() {
    ...
    auto gateway = new Gateway("192.168.1.13", 5450, receiveBuffer, connectionManager);
    auto transmitter = new Transmitter("192.168.1.13", 5451, outputBuffer,  connectionManager, consoleMutex);
